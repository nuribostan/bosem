...
const BizeUlasin = () => {
  ...
  return (
    ...
    >
      <h1 className="text-[120px] text-bizlere-ulasin-foreground font-light  max-sm:text-5xl max-w-324 pt-30 mx-auto  max-xl:text-8xl">
        Bizlere Ulaşın
      </h1>

      <p className="text-2xl text-bizlere-ulasin-foreground font-light max-w-324 w-1/2 mx-auto text-center max-sm:text-lg max-md:w-full max-xl:text-xl">
