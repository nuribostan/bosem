  ...
  return (
    ...
    >
      ...
      <div className="title max-w-324 mx-auto w-full flex flex-col gap-10 justify-center items-center max-2xl:gap-6">
        <h1 className="text-[120px] text-bizlere-ulasin-foreground font-light  max-sm:text-2xl  max-2xl:text-8xl max-md:text-6xl">
          Hakkımızda
        </h1>

        <p className="text-2xl text-bizlere-ulasin-foreground font-light w-3/4 mx-auto text-center max-sm:text-sm max-md:w-full max-2xl:text-xl max-md:text-lg">
      ...
      <div className="adres flex justify-between items-center w-full max-w-324 mx-auto mt-20 ">
        <div className="adres-item flex flex-col items-center justify-center gap-4">
          <div className="adres-item-title flex flex-col justify-center items-center gap-2">
            <h1 className="text-white text-xl font-semibold uppercase max-2xl:text-lg max-sm:text-sm">
              Adres
            </h1>
